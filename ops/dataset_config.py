...
def return_kinetics(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'Kinetics400/'
        filename_imglist_train = '/kaggle/input/dataset4kinetics/datasets/Kinetics400/annotations/train_data.txt'
        filename_imglist_val = '/kaggle/input/dataset4kinetics/datasets/Kinetics400/annotations/val_data.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
